  ...
  return (
    ...
    >
      <article className="flex flex-col items-center text-center">
        <div className="relative h-52 w-52 overflow-hidden rounded-full border border-black/10 bg-surface shadow-sm transition-transform duration-200 group-hover:scale-[1.02] sm:h-56 sm:w-56">
          <Image
            src={member.imageSrc}
            alt={member.name}
            fill

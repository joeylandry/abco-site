...
export default function MobileBeerCard({ beer }: { beer: Beer }) {
  ...
  return (
    <Link
      href={`/beer/${beer.id}`}
      className="group block h-full overflow-hidden rounded-none border shadow-[0_18px_40px_rgba(0,0,0,0.08)] transition-transform duration-200 hover:-translate-y-1"
      style={{

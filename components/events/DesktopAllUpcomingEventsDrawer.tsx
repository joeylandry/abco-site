    ...
    <>
      <div className={clsx("flex justify-center", className)}>
        <button
          ...
          aria-controls="desktop-events-drawer"
      ...
      {isDrawerRendered && typeof document !== "undefined"
        ? createPortal(
            <div className="fixed inset-0 z-[100]">
              ...
              <div
                id="desktop-events-drawer"
                role="dialog"
                aria-modal="true"
                aria-label="Upcoming events calendar"
                className={`absolute inset-y-0 right-0 flex h-full w-[min(40vw,42rem)] flex-col overflow-y-auto overscroll-contain border-l border-black/10 bg-background shadow-[0_28px_80px_rgba(15,23,42,0.18)] transition-transform duration-300 ease-out touch-pan-y ${
